...
/*
	...
	touch-screen e o microcontrolador. Neste exemplo temos 2 botões impressos 
	na tela e a ação é ligar e desligar um relé.
*/
...
unsigned char retorna_pixel(unsigned char eixo, unsigned char valor);
...
#define MAX_X 235       //calibração com as posições min e max de x e y
#define MIN_X 14
#define MAX_Y 226
#define MIN_Y 29

#define TXT1_X1  25    //posição do texto 1
#define TXT1_Y1  40

#define TXT2_X1  85    //posição do texto 2
#define TXT2_Y1  40

#define BOT1_X1  TXT1_X1-2  //coordenada do botão 1
#define BOT1_Y1  TXT1_Y1-2
#define BOT1_X2  BOT1_X1+14
#define BOT1_Y2  BOT1_Y1+10

#define BOT2_X1  TXT2_X1-2  //coordenada do botão 2
#define BOT2_Y1  TXT2_Y1-2
#define BOT2_X2  BOT2_X1+20 
#define BOT2_Y2  BOT2_Y1+10
...
unsigned char texto1[] = "VENTILADOR:";
unsigned char texto2[] = "ON";
unsigned char texto3[] = "OFF";
...
unsigned char pos_pixel_x;
unsigned char pos_pixel_y;
...
#define VENTILADOR  PORTBbits.RB4
...
void main()
{
	...
	TRISB = 0b00101100;                 //CONFIG DIREÇÃO DOS PINOS PORTB
	TRISC = 0b01111101;		            //CONFIG DIREÇÃO DOS PINOS PORTC
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
	...
	glcd_text57(30,10,texto1,1,1);	// Escreve tela com texto e nome
			                        // das posições
			                        
	glcd_rect(BOT2_X1, BOT2_Y1, BOT2_X2, BOT2_Y2, 1, 1);
	glcd_text57(TXT2_X1,TXT2_Y1,texto3,1,0);
	
	glcd_rect(BOT1_X1, BOT1_Y1, BOT1_X2, BOT1_Y2, 0, 1);
	glcd_text57(TXT1_X1,TXT1_Y1,texto2,1,1);
	...
	while(1)
	{
				...
				{
                    pos_pixel_x = retorna_pixel(X, coluna_touch);
                    pos_pixel_y = retorna_pixel(Y, linha_touch);
                    
                    if(((pos_pixel_x > BOT1_X1) && (pos_pixel_x < BOT1_X2))&&((pos_pixel_y > BOT1_Y1) && (pos_pixel_y < BOT1_Y2)))
                    {
                    	glcd_rect(BOT1_X1, BOT1_Y1, BOT1_X2, BOT1_Y2, 1, 1);
                    	glcd_text57(TXT1_X1,TXT1_Y1,texto2,1,0);
                    	
                    	glcd_rect(BOT2_X1, BOT2_Y1, BOT2_X2, BOT2_Y2, 1, 0);
                        glcd_rect(BOT2_X1, BOT2_Y1, BOT2_X2, BOT2_Y2, 0, 1);
                    	glcd_text57(TXT2_X1,TXT2_Y1,texto3,1,1);
                    	
                        VENTILADOR = 1;
                    }    
				
                    if(((pos_pixel_x > BOT2_X1) && (pos_pixel_x < BOT2_X2))&&((pos_pixel_y > BOT2_Y1) && (pos_pixel_y < BOT2_Y2)))
                    {
                    	glcd_rect(BOT2_X1, BOT2_Y1, BOT2_X2, BOT2_Y2, 1, 1);
                    	glcd_text57(TXT2_X1,TXT2_Y1,texto3,1,0);
                    	
                    	glcd_rect(BOT1_X1, BOT1_Y1, BOT1_X2, BOT1_Y2, 1, 0);
                    	glcd_rect(BOT1_X1, BOT1_Y1, BOT1_X2, BOT1_Y2, 0, 1);
                    	glcd_text57(TXT1_X1,TXT1_Y1,texto2,1,1);
...
unsigned char retorna_pixel(unsigned char eixo, unsigned char valor)
{
    ...
    if(eixo == X)
    {
        pixel = (128*((signed int)valor - MAX_X))/(MIN_X-MAX_X);
        if(pixel < 0) return(0);
        else return((unsigned char)pixel);
    }
    else if(eixo == Y)
    {
        pixel = (64*((signed int)valor - MIN_Y))/(MAX_Y-MIN_Y);
        if(pixel < 0) return(0);
        else return((unsigned char)pixel);
    }
    else
