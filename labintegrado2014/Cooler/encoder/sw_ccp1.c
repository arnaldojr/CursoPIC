...
void main(void)
{
	...
	INTCONbits.GIE = 0;			//Habilita interrupções de alta prioridade
	//INTCONbits.PEIE = 1;		//Habilita interrupções de baixa prioridade

	OpenPWM1(24);	//Tpwm = 25us => maxPWM = 100
	SetDCPWM1(dutyPWM);
	DisablePullups();
	...
	while(1)	//Loop principal
	{
		...
		SetDCPWM1(dutyPWM);	//"Seta" novo duty-cycle		
